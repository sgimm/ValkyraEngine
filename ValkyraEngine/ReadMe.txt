========================================================================
    WIN32-ANWENDUNG: [!output PROJECT_NAME]-Projektübersicht
========================================================================
...
Resource.h
    ...
    Dies ist eine Symboldatei, die als Anwendungssymbol (32x32) verwendet wird. Dieses Symbol ist in der Hauptressourcendatei "[!output RC_FILE_NAME]"     enthalten.

small.ico
    Dies ist eine Symboldatei, die eine kleinere Version (16x16) des Anwendungssymbols enthält. Dieses Symbol ist in der Hauptressourcendatei "[!output RC_FILE_NAME]"     enthalten.
